...
- 2026-08-16 v.1.1.0: Code refactored. Fixed: Bug in right-aligned text. Bug in TTYDashboard view. Optimized the Open-Meteo querying. DashboardView got a facelift. Finally added following of custom latitude and longitude by command-line parameters.
